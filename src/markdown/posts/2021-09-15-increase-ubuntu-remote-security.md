...
파일 시스템에 직접적으로 영향을 주는 통신은 <span class="blue-400">SSH</span>, <span class="blue-400">SFTP</span>가 존재한다. 각 프로토콜의 전신인 Telnet과 FTP는 SSL의 미적용으로 OS 설치 시 비활성화 되어있다. 굳이 해당 프로토콜을 쓸 이유조차 없으니, 여기서는 논외로 한다.
