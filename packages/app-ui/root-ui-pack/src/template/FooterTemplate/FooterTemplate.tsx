		...
		>
			...
			<Box display='grid' gap={2} gridTemplateColumns='1fr 1fr 1fr'>
				<FooterLinkButton link='https://blog.itcode.dev'>
					<img alt='blog.itcode.dev' height='100%' src='https://blog.itcode.dev/logo.png' width='100%' />
				</FooterLinkButton>
			...
			<Hits
				...
				text='view'
				titleBgcolor='#242424'
				unique={process.env.NODE_ENV === 'development' ? 'http://example.com' : 'https://itcode.dev'}
			/>
		</Stack>
	);
}